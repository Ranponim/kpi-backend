...
from .routers import analysis, analysis_v2, preference, kpi, statistics, master, llm_analysis, llm_analysis_v2, peg_comparison, async_analysis
...
app.include_router(llm_analysis.router) # LLM 분석 API (Old)
app.include_router(llm_analysis_v2.router) # LLM 분석 API V2 (MCP 직접 호출)
